      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <motion.a
            ...
            className="text-2xl font-bold tracking-tighter text-white font-sans cursor-pointer"
          >
            MaBa Consulting
          </motion.a>
              ...
              return (
                ...
                >
                  <a
                    ...
                    className={`flex items-center gap-1 text-sm transition-colors duration-200 relative group ${
                  ...
                  <motion.div
                    className="absolute top-full left-0 mt-2 w-48 glass rounded-lg p-2"
          ...
          <div className="lg:hidden">
            ...
            {mobileMenuOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="absolute top-full left-0 right-0 glass border-t border-white/10 mt-2"
              >
